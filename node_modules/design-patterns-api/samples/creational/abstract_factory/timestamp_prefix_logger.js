...
class TimestampPrefixLogger extends MxI.$Implementation(MxI.$ConsoleLogSink).$with(MxI.$ILogSink) {
  constructor(...args) {
	  super();
...
MxI.$setClass(TimestampPrefixLogger).$asImplementationOf(MxI.$ILogSink);
